...
const questions = [
  {
    id: 3,
    tag: 'uwu',
    text: '🎬 Nochecita de tele',
    options: [
      'UnShowMas',
      'Peliculas Netflixx',
      'Documental (?',
      'Anime / Estudio Ghibliii',
    ],
  },
  {
    id: 4,
    ...
    text: 'Tardecita?',
    options: [
      'Ver Animalitos y Jardincito',
      '🔭 Planetario — explorar el universo juntos',
      '🎮 Juegitos — music & chill',
      'Donde nos lleve el viento <3 ',
    ],
  },
  {
    id: 5,
    tag: 'uwu',
    text: '🍽el stack gastronómico de la noche',
    options: [
      '🍕 Pizza — 🍕',
      '🍣 Sushi — veggie 🍣',
      '🍔 Burger —  🍔',
  ...
  },
  {
    ...
    options: [
      ...
      '🎵 Playlist , Escabio , Juegitos ',
      'Salir de jodita juntada :p',
